      ...
      <section className="container-wrapper grid items-center gap-8 pt-6 pb-8 md:py-10">
        <div className="flex flex-col items-start gap-2">
          ...
          <div className="w-full">
            ...
            <div
              className="mt-2 w-full rounded-lg bg-red-50 p-4 text-sm leading-6 font-medium text-red-800 lg:w-3/4 dark:bg-gray-800 dark:text-red-400"
              role="alert"
            >
          ...
          <div
            className="mt-2 w-fit rounded-lg bg-red-50 p-4 text-sm leading-6 font-medium text-red-800 dark:bg-gray-800 dark:text-red-400"
            role="alert"
          >
