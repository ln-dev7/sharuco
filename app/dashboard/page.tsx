  ...
  return (
    <>
      ...
      <section className="container grid items-center gap-6 pt-6 pb-8 md:py-10">
            ...
            <AlertDialogContent className="scrollbar-hide max-h-[640px] overflow-hidden overflow-y-auto">
              <AlertDialogHeader>
                ...
                <AlertDialogDescription>
                  ...
                  {isErrorAddOnGithubGist.isUnauthorized && (
                    <div
                      className="mt-4 w-full rounded-lg bg-red-50 p-4 text-sm leading-6 font-medium text-red-800 lg:w-3/4 dark:bg-gray-800 dark:text-red-400"
                      role="alert"
                    >
                      <Link href="/add-personal-access-token">
        ...
        <Separator className="my-4" />
        <div className="flex flex-col items-start gap-2">
          <h1 className="mb-2 text-2xl leading-tight font-extrabold tracking-tighter">
            Danger Zone
          </h1>
